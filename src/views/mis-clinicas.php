                    ...
                    <form action="" method = "POST">
                        <div class="modal-body container">
                            <div class="d-flex flex-column container-fluid mb-5">
                                <label for="name" class="form-label d-flex container-fluid">Nombre de la clinica</label>
                                <input class="" type="text" name="name" id="name">
                                <label for="dir" class="form-label d-flex container-fluid">Dirreción de la clinica</label>
                                <input class="" type="text" name="dir" id="dir">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <a href="nuevo-medico.html" class="cancel-box btn btn-secondary px-4">Cancelar</a>
